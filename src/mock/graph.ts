...
export const KNOWLEDGE_GRAPH_DATA: GraphData = {
    nodes: [
        ...
        },
        {
            ...
            type: 'main',
            label: '사과',
            description: '지혜, 유혹, 지식의 열매 등 다양한 상징성을 가진 과일입니다.',
            radius: 40,
            color: '#409659'
        },
        {
        ...
        },
        {
            ...
            type: 'sub',
            label: '지혜',
            description: '지혜의 상징으로, 아담과 이브가 먹은 금단의 열매로 묘사됩니다.',
            radius: 11,
            color: getRandomColor()
        }
    ],
    links: [
        { source: 'center-peach', target: 'n1' },
        { source: 'center-peach', target: 'n2' },
        { source: 'center-peach', target: 'n3' },
        { source: 'center-peach', target: 'n4' },
        { source: 'center-peach', target: 'n5' },
        { source: 'center-peach', target: 'n6' },
        { source: 'center-peach', target: 'n7' },
        { source: 'center-peach', target: 'n8' },
        { source: 'center-apple', target: 'n9' }
    ]
};
